        ...
        <div className="max-w-4xl mx-auto">
            ...
            {result && (
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    {/* Similar Items */}
                    <div>
                        <h3 className="text-xl font-bold mb-4 text-gray-900">Similar Items in Wardrobe</h3>
                            ...
                            {result.similarItems.map((item: any) => (
                                <div key={item.id} className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100">
                                    ...
                                    <div className="p-3">
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">Match: {Math.round(item.similarity * 100)}%</p>
                                    </div>
                                </div>
                            ))}
                        </div>
