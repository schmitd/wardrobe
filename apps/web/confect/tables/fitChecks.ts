...
export default Table.make(() => Schema.Struct({
  ...
  wearOccurrenceId: Schema.optionalKey(GenericId.GenericId("wearOccurrences")),
  wearRetractedAt: Schema.optionalKey(Schema.Number),
  capturedAt: Schema.optionalKey(Schema.Number),
