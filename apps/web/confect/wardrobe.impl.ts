...
import { pageCollections, pagePieces, pageInspiration, itemDetails, saveNote } from "./collectionHandlers";
...
export default GroupImpl.make(databaseSchema, group).pipe(
  Layer.provide(Layer.mergeAll(
    pageCollections, pagePieces, pageInspiration, itemDetails, saveNote, RequireUserLive,
