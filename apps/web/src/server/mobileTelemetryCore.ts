...
for (const operation of ["planning_load", "planning_generate", "planning_accept", "planning_edit", "planning_dismiss", "planning_worn", "calendar_list", "calendar_connect", "calendar_disconnect"]) operations.add(operation);
