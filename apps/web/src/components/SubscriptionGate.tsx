...
export default function SubscriptionGate({ children }: { children: React.ReactNode }) {
    ...
    if (!isSubscribed) {
        return (
            <div className="rack-panel rack-panel--sky mx-auto mt-8 flex max-w-2xl flex-col items-center justify-center p-12">
                ...
                <a
                    href="/pricing"
                    className="mt-4 border-2 border-black bg-[#EAC99A] px-6 py-3 text-xs font-black uppercase tracking-[0.14em] text-[#310A31] shadow-[4px_4px_0_rgb(0_0_0_/_0.18)]"
                >
                    View Plans
                </a>
            </div>
