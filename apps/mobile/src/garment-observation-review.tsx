...
export function GarmentObservationReview({ observations }: { observations: GarmentObservation[] }) {
  ...
  return (
    <View style={{ borderTopWidth: 1, borderTopColor: colors.washStrong, paddingTop: 12, gap: 12 }}>
      <View style={{ gap: 3 }}><Text selectable style={{ color: colors.plum, fontSize: 11, fontWeight: "900", textTransform: "uppercase", letterSpacing: 0.7 }}>Detected pieces</Text><Text selectable style={{ color: colors.muted, fontSize: 12, lineHeight: 17 }}>Nudge only uncertain matches so repeat-wear history stays accurate.</Text></View>
