...
export function ItemDetailScreen() {
  ...
  return (
    <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={{ padding: 20, paddingBottom: 70, gap: 18 }}>
      ...
      <Image source={item.imageUrl} style={{ width: "100%", aspectRatio: 0.82, backgroundColor: colors.wash, borderWidth: 1, borderColor: colors.line, borderRadius: 16 }} contentFit="contain" />
